...
//        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let redemptionType = self.VM.myredemptionArray[indexPath.item].redemptionType
        if redemptionType != 3 && redemptionType != 4 && redemptionType != 5{
            ...
            let strDate = self.VM.myredemptionArray[indexPath.row].jRedemptionDate ?? "01/01/0001"
            print(strDate)
