...
import Firebase
import Lottie
class EBC_DefaultAddressVC: BaseViewController {
...
//                    self.present(vc!, animated: true, completion: nil)
                ...
                if self.totalPoint <= Int(self.pointBalance) {
                    let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "EBC_RedemptionSubmissionVC") as? EBC_RedemptionSubmissionVC
