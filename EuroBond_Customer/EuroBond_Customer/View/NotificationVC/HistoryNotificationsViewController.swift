...
class HistoryNotificationsViewController: BaseViewController, notificationDelgate {
    func didTappedNotificationimage(cell: HistoryNotificationsTableViewCell) {
        ...
        expandedimageview.kf.setImage(with: URL(string: "\(PROMO_IMG1)\(secondaryIMG)"), placeholder: UIImage(named: "no_image1.jpg"))
    ...
    var loyaltyIds = UserDefaults.standard.string(forKey: "LoyaltyId") ?? ""
...
//        cell.notificationImg.sd_setImage(with: URL(string: PROMO_IMG + receivedImage), placeholderImage: UIImage(named: "no_image1.jpg"))
        ...
        if  receivedImage != ""{
            ...
            cell.notificationImg.kf.setImage(with: URL(string: "\(PROMO_IMG1)\(receivedImage.dropFirst(1))"), placeholder: UIImage(named: "no_image1.jpg"))
        }else{
